	...
	<div id="main">
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				...
				<div id="right">
					<%--<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible;" scrolling="no" frameborder="no" width="100%" height="650"></iframe>--%>
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible;" scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By Coolshow<!-- <a href="http://jeesite.com" target="_blank">Coolshow</a> --> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
