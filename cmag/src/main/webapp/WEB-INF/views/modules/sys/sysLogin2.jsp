...
<body>
	...
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')}<!-- <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> --> - Powered By Coolshow<!-- <a href="http://jeesite.com" target="_blank">Coolshow</a> --> ${fns:getConfig('version')}
	</div>
