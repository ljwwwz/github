...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			// 用户-角色
		 	var zNodes=[
					<c:forEach items="${RoleList}" var="role">{id:"${role.id}", name:"${role.name}"},
		            </c:forEach>];
			// 初始化树结构
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<%-- <div class="controls">
				...
				<div id="roleTree" class="ztree" style="margin-left:100px;margin-top:3px;float:left;"></div>
