		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">
					生成结构：{包名}/{业务系统名或框架模块名}/{分层(dao,entity,service,web)}/{子模块名}/{java类}
				</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：框架com.coolshow.frm.jeesite.modules|业务${busiPakageprefix}</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">业务系统名或框架模块名:</label>
			<div class="controls">
				<form:input path="moduleName" htmlEscape="false" maxlength="500" class="required input-xlarge" value="${busiModules}"/>
				<span class="help-inline">业务系统名或框架模块名，业务系统必须取值为${busiModules}</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">可选，业务系统时建议添加此值 </span>
			</div>
		</div>
		<div class="control-group">
